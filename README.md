...
```
micro-ts-github-readme/
├── .gitignore
├── detectsStack/   # detectsStack module
│   └── readmeGenerator.ts
├── package-lock.json
├── package.json
...
│   └── server.ts
├── streamingAPI/   # streamingAPI module
│   └── repoAnalyzer.ts
├── tsconfig.json
└── watch.ts
```
...
```bash
git clone https://github.com/mohamedhamdhy/micro-ts-read-sys
cd micro-ts-github-readme
```
